export default function Content() {
  ...
  return (
    <main className="relative min-h-screen bg-[#d9fce8] text-neutral-950 antialiased font-sans">
      <div className="mx-auto w-full max-w-6xl px-6 py-12 md:px-10 md:py-14 lg:px-12 lg:py-8">
        <img
          src="/interfold-logo.png"
          alt="The Interfold"
          className="w-[170px] md:w-[200px] opacity-95"
        />

        <div className="mt-14 grid gap-x-16 gap-y-12 lg:grid-cols-[minmax(0,_1fr)_360px]">
          <div className="max-w-4xl">
            ...
            <div className="mt-10 max-w-[40rem] space-y-6 text-[18px] leading-8 text-neutral-700 md:text-[19px] md:leading-9">
              <p>
                <strong>The Interfold</strong> enables independent parties to produce shared,
                verifiable outcomes from private inputs.
              </p>

              <p>
                It introduces a structural fold in digital systems, making coordination
                possible without custody, exposure, or trusted hardware.
              </p>
            </div>
          </div>
