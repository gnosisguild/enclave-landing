  ...
  return (
    <div className='flex flex-col gap-8'>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <p className='text-lg md:text-xl'>Enclave's Encrypted Execution Environments (E3s) make multiparty computation <br></br>private, provable, and deployable anywhere.</p>
        <br />
        <br />
