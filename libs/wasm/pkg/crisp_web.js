...
const EncryptFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_encrypt_free(ptr >>> 0));
/**
*/
export class Encrypt {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        EncryptFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_encrypt_free(ptr);
    }
    /**
    */
    constructor() {
    ...
    */
    encrypt_vote(vote, public_key) {
        try {
            ...
            wasm.encrypt_encrypt_vote(retptr, this.__wbg_ptr, vote, ptr0, len0);
    ...
    */
    encrypt_message(message, public_key) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray64ToWasm0(message, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray8ToWasm0(public_key, wasm.__wbindgen_malloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.encrypt_encrypt_message(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('crisp_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
