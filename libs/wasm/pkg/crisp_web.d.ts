...
* @returns {Uint8Array}
*/
  encrypt_message(message: BigUint64Array, public_key: Uint8Array): Uint8Array;
/**
*/
  static test(): void;
}
...
export interface InitOutput {
  ...
  readonly encrypt_encrypt_message: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
